...
type PrivacySearchType = "cpf" | "email";
...
const PRIVACY_BACKFILL_BATCH_SIZE = 150;
...
function normalizeCpfForPrivacy(value: string): string {
...
function normalizeEmailForPrivacy(value: string): string {
...
function buildPrivacyIndex(cpf: string, email: string): { cpfHash: string; emailHash: string } {
  return {
...
function hasPrivacyIndex(data: Record<string, unknown>): boolean {
...
function validatePrivacyReason(value: unknown): string {
...
async function writePrivacyAudit(data: {
